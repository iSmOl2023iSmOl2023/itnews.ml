					...
					<div class="box-content">
						<table class="table table-striped table-bordered bootstrap-datatable datatable">
						  ...
						  <?php 
						  		...
						  		$select = "select * from news  where `status`=''";
						  ...
						  <tbody>
							<tr>
								...
								<td class="center">
									<a class="btn btn-info" href="index.php?edit_news=<?php echo $id;?>">
										<i class="halflings-icon white edit"></i>  
									</a>
									<a class="btn btn-danger" href="index.php?delete_news=<?php echo $id;?>">
